...
//                in=new DataInputStream(client.getInputStream());
    ...
    public void MulticastStringReceive()
    {
        ...
        while(true)
        {
            try {
                ...
                //x=byteArrayToInt(dp.getData());
               // System.out.println("Receiving int:" + x);
    ...
    public void MakeMultiCastOutput()
    {
...
//                           parent.open=false;
                        ...
                        parent.frame.dispose();
                            parent.frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
